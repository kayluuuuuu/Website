<?php include 'base.php';
    ...
    $filterbutton = "<a href='filter.php' class='waves-effect waves-light btn'>FILTER</a>";

	if(!empty($_SESSION['filter']) && !empty($_SESSION['filter_val']))
	{
		$filterbutton = "<a href='clear.php' class='waves-effect waves-light btn'>CLEAR FILTER</a>";
			...
			<table class="centered">
				<thead>
					<tr>
          				...
          				<th data-field="year">Year Accomplished</th>
				...
				<tbody>
			        ...
			        <tr>
		                ...
		                <td><?php echo $results->data[$i]['yearAccomp']; ?></td>
		                <td><?php 
